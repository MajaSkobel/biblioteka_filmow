...
def get_items(library_titles, chosen_type):
    chosen_items = [item for item in library_titles if type(item) == chosen_type]
...
def top_titles(library_titles,number,content_type=None):
    ...
    for item in library_titles_sorted[:number]:
        print(item)
